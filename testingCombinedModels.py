...
if __name__ == "__main__":
    ...
    teGenOrbs = [genuinePairsLBPHoG[i]+genuinePairs[i] for i in genuinePairs if getUser(i,mode)> int(args.numUsers)*0.75 ]
    teForgOrbs = [forgeriesPairsLBPHoG[i]+forgeriesPairs[i] for i in forgeriesPairs if getUserF(i,mode)> int(args.numUsers)*0.75 ]
